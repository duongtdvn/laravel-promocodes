...
class NotificationTableCommand extends Command
{
     ...
     * @var string
     */
    protected $description = 'Create a migrations for the notifications table';
    ...
    /**
     * Create a base migrations file for the notifications.
     *
     * @return string
     */
    protected function createBaseMigration()
    {
        ...
        return $this->laravel['migrations.creator']->create($name, $path);
    }
}
